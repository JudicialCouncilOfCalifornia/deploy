...
USER www-data
RUN cd /tmp && virtualenv /usr/share/docassemble/local && . /usr/share/docassemble/local/bin/activate && pip install /tmp/docassemble/docassemble /tmp/docassemble/docassemble_base /tmp/docassemble/docassemble_demo /tmp/docassemble/docassemble_webapp
USER root
